...
class ReviewManageService {
    ...
    func getUserReview(completion: @escaping (NetworkResult<Any>) -> Void) {
        let url: String! = RebornManageServiceUrl
        ...
        dataRequest.responseData { response in
            ...
            case .success:
                ...
                dump(value)
                let networkResult = self.judgeStatus(by: statusCode, value, ReviewManageModel.self)
