...
//    }
    ...
    @IBAction func requestButtonTapped() {
        ...
        let url = "http://www.rebornapp.shop/users/login/mailConfirm?userEmail=\(EmailTextField.text ?? "")"



        let paramettaData = Model3(email: EmailTextField.text ?? "")
        print(paramettaData)
        ...
        print("암호화 된 인증 코드 = "+UserEmailText)
    }
