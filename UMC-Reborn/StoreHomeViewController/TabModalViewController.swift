...
class TabModalViewController: TabmanViewController {
    ...
    private func setupTab(){
        let firstVC = UIStoryboard.init(name: "StoreTab", bundle: nil).instantiateViewController(withIdentifier: "FirstTabVC") as! FirstTabViewController
        let secondVC = UIStoryboard.init(name: "StoreTab", bundle: nil).instantiateViewController(withIdentifier: "SecondTabVC") as! SecondTabViewController
...
extension TabModalViewController: PageboyViewControllerDataSource, TMBarDataSource {
